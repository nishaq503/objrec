...
from .lebedev import OctahedralMatrixRotationGroup2Generators
from .lebedev import ActionOctahedralRotationGroupOnLebedevGridFunctions
from .lebedev import LebedevGrid26


class DistanceNPHT2d:
    def __init__(self,
        ...
        wasserstein_internal_norm:
            int or str. Internal norm used in wasserstein dist. Use 'inf' to set to infinity norm or q >= 1 for q-norm.
    ...
    def __call__(self, t_1: [[[]]], t_2: [[[]]]):
        ...
        Parameters
        ----------
        t_1 : [[[]]]. Discretized npht over equidistant distributed directions on S^1.
...
class DistanceNPHT3DLebedev26:
    def __init__(self,
                 wasserstein_degree: int = 2,
                 wasserstein_internal_norm: int = 2,
    ...
    def __call__(self, t_1: [[[]]], t_2: [[[]]]):
        ...
        Parameters
        ----------
        t_1 : [[[]]]. Discretized npht over 26 point Lebedev Grid.
    ...
    def _calculate_rotation_optimized_distance(self, t_1, t_2):
        ...
        distances = []
        o_ = OctahedralMatrixRotationGroup2Generators()
...
def distance_npht2D(npht_1: [[[]]],
    ...
    Parameters
    ----------
    npht_1 : [[[]]]. Discretized npht over equidistant distributed directions on S^1.
    ...
    -------
    """
    f = DistanceNPHT2d(wasserstein_degree=wasserstein_degree,
...
def distance_npht3D_lebedev_26(npht_1: [[[]]],
    ...
    Parameters
    ----------
    npht_1 : [[[]]]. Discretized npht over 26 point Lebedev Grid.
    ...
    -------
    """
    f = DistanceNPHT3DLebedev26(wasserstein_degree=wasserstein_degree,
                                wasserstein_internal_norm=wasserstein_internal_norm,
                                included_dimensions=included_dimensions,
                                minimize_over_rotations=minimize_over_rotations)
