...
class _LebedevOrbitBase:
    ...
    under the Octahedral Symmetry Group.
    """
    ...
    def point_permutation_by_generator(self, octahedral_rotation_group_matrix_implementation):
        ...
        """
        o_ = octahedral_rotation_group_matrix_implementation()
        return_value = {}
        generator_words = o_.generators
        for generator in generator_words:
            mapping = {}
            for p in self:
                generator_matrix = o_.word_to_matrix(generator)
...
class LebedevOrbitA1(_LebedevOrbitBase):
    """
    Orbit of (1, 0, 0).
    """
...
class LebedevOrbitA2(_LebedevOrbitBase):
    """
...
class LebedevOrbitA3(_LebedevOrbitBase):
    """
...
def LebedevGridMeta(lebedev_point_sets: [_LebedevOrbitBase]) -> type:
    ...
    class LebedevGrid:
        ...
        def point_permutation_by_generator(self, octahedral_rotation_group_matrix_implementation):
            ...
            g_ = OctahedralMatrixRotationGroup2Generators()
            generator_words = g_.generators
...
LebedevGrid26 = LebedevGridMeta([LebedevOrbitA1, LebedevOrbitA2, LebedevOrbitA3])
